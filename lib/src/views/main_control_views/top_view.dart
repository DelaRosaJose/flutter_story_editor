  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
          horizontal: 15,
          vertical: Platform.isIOS ? 60 : 40), // Padding adjusted for platform differences.
      child: Column(
        children: [
          Row(
            mainAxisAlignment:
                MainAxisAlignment.spaceBetween, // Space between controls and the close icon.
            children: [
              ...
              Row(
                children: [
                  ...
                  // Crop icon for image editing. Only show if not a video.
